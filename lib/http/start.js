...
function startServer(config, httpConfig) {
  ...
  processRequest.on('transaction', function(transaction){
    
    transaction.on('requested-cache', function(pay){
      console.log("from cache")
    });

    transaction.on('requested-optimized', function(pay){
      console.log("from optimized")
    });

    transaction.on('requested-original', function(pay){
